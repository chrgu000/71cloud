...
- (void)createUI{
    NSArray *arr = @[@"头像",@"用户名",@"姓名",@"公司名称",@"党支部名称"];
    ...
    for (int i = 0; i<5; i++) {
        ...
        if (i == 0) {
            ...
            UserNameL = rightL;
            UserNameL.text = [NSString replaceStringNull:self.DataDic[@"user"][@"nickname"]] ;
            ...
            backV.frame = CGRectMake(0, 158 +53, SCREEN_W, 52);
            companyL = rightL;
            companyL.text =  [NSString replaceStringNull:self.DataDic[@"user"][@"company_name"]];
        }
        else{
            backV.frame = CGRectMake(0, 158+53*2, SCREEN_W, 52);
            zuzhiL = rightL;
            zuzhiL.text =  [NSString replaceStringNull:self.DataDic[@"user"][@"branchs_name"]];
        }
