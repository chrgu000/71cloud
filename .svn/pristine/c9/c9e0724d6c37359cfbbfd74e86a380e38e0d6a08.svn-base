...
(function( root, factory ) {
    ...
    if ( typeof module === 'object' && typeof module.exports === 'object' ) {
        ...
        // Allow using this built library as an AMD pagemodule
     ...
     *
     * * pagemodule `base`：WebUploader.Base
     * * pagemodule `file`: WebUploader.File
     * * pagemodule `lib/dnd`: WebUploader.Lib.Dnd
     * * pagemodule `runtime/html5/dnd`: WebUploader.Runtime.Html5.Dnd
     *
     *
     * 以下文档将可能省略`WebUploader`前缀。
     * @pagemodule WebUploader
