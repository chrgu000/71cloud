...
CREATE TABLE `c_permissions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='权限列表';

-- ----------------------------
-- Records of c_permissions
-- ----------------------------
INSERT INTO `c_permissions` VALUES ('1', '廉政中国', 'admin', 'lian/index', null, '0', '0', '1536300390', null, '1', null);
...
INSERT INTO `c_permissions` VALUES ('4', '时政热点', null, null, null, '1', '0', '1536300390', null, '1', null);
INSERT INTO `c_permissions` VALUES ('5', '警示教育', null, null, null, '1', '0', '1536300390', null, '1', null);
...
CREATE TABLE `c_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='角色表';

-- ----------------------------
-- Records of c_role
-- ----------------------------
INSERT INTO `c_role` VALUES ('2', 'fasdf111', '1536577382', '2,7,8,9,10,3,11,12,13,14', 'fasdfdsa', '1');
INSERT INTO `c_role` VALUES ('6', '廉政中国', '1536643899', '1,4,5,6', '111111', '0');
...
CREATE TABLE `c_weixin` (
  ...
  `appid` varchar(20) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT '微信公众号的appid',
  PRIMARY KEY (`id`)
...
-- Records of c_weixin
-- ----------------------------
INSERT INTO `c_weixin` VALUES ('1', null, null, '新风国机', '0', null);
INSERT INTO `c_weixin` VALUES ('2', null, null, '71cloud', '0', null);
INSERT INTO `c_weixin` VALUES ('3', '0', '0', 'fasdfdasf', '2', null);
INSERT INTO `c_weixin` VALUES ('4', 'fasdfdsadfas', '0', 'dfsadfasdf', '2', null);
