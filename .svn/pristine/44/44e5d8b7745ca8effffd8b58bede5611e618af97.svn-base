...
CREATE TABLE `c_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='系统管理员表';
...
CREATE TABLE `c_user` (
  ...
  `password` varchar(32) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT '用户密码',
  `party_member` int(2) NOT NULL COMMENT '是否是党员（0代表不是，1代表是党员）',
  `ctime` int(30) NOT NULL COMMENT '创建时间',
  `token` varchar(255) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT '用户的token',
  `company` varchar(255) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT '所属公司',
  ...
  `unionid` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'unionid',
  `openid` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  `face` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT '头像',
  `party_status` int(2) DEFAULT NULL COMMENT '党员状态（0代表是党员，1代表是群众）',
  `branchs_id` int(10) DEFAULT NULL COMMENT '子支部id',
  `nickname` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT '微信用户昵称',
  `weixin_id` int(10) DEFAULT NULL COMMENT '微信的id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='用户表';
