//
//  AntiCorruptionViewController.m
//  TheParty
//
...
@interface AntiCorruptionViewController ()<XYYSegmentControlDelegate>
...
@implementation AntiCorruptionViewController
...
- (void)viewWillDisappear:(BOOL)animated {
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"NewsWebData" object:nil];
...
- (void)creatData{
    [self showHUD:nil];
    WEAKSELF
    [ConnectionRequestMgr GetSessionWithUrl:ClearClass parameter:nil successBlock:^(NSDictionary *dict) {
        [weakSelf hideHUD];
...
{
    AntiRootViewController *root = [[AntiRootViewController alloc] init];
...
{
    AntiRootViewController *root = view.viewArray[number];
