...
{
    [[UIHelper sharedSingleton] pushVC:@"NewsWebViewController" vc:self parames:@{@"str":bannerArr[index][@"url"],@"Titlestr":bannerArr[index][@"title"],@"ID":bannerArr[index][@"id"],@"Islike":bannerArr[index][@"is_praise"],@"type":NewsID}];
