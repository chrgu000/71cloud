...
@interface NotificationViewController ()<XYYSegmentControlDelegate>
...
- (void)viewDidLoad {
    ...
    [self showHUD:nil];
    WEAKSELF
    [ConnectionRequestMgr GetSessionWithUrl:NoticeClass parameter:nil successBlock:^(NSDictionary *dict) {
...
{
    NotificationRootViewController *root = [[NotificationRootViewController alloc] init];
...
{
    NotificationRootViewController *root = view.viewArray[number];
