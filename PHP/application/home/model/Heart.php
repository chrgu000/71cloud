...
class Heart extends Model{
     ...
     *
     * 投稿
     * @param $title string 稿件名称
     * @param $uid int 用户id
     * @param $cate_id string 分类id
     * @param $content string 稿件内容
     *
     */
    public function contribute($title,$uid,$cate_id,$content){

        $res = $this->add(['title'=>$title,'uid'=>$uid,'cate_id'=>$cate_id,'content'=>$content,'ctime'=>time()]);
