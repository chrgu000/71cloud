...
-- ----------------------------
INSERT INTO `c_branch_admin` VALUES ('1', 'admin', '383eafdd5d7d6221612fe7e10cf703f0', '0', '0', '13245678945', '1', '1536300390', '0', '0', '总支部管理员', null);
...
CREATE TABLE `c_permissions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='权限列表';

-- ----------------------------
-- Records of c_permissions
-- ----------------------------
INSERT INTO `c_permissions` VALUES ('1', '廉政中国', 'admin', 'lian/index', null, '0', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('2', '国机新风', 'admin', null, null, '0', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('3', '纪检在线', null, null, null, '0', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('4', '时政热点', null, null, null, '1', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('5', '警示教育', null, null, null, '1', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('6', '党纪国法', null, null, null, '1', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('7', '新风讲堂', null, null, null, '2', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('8', '新风展馆', null, null, null, '2', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('9', '新风社区', null, null, null, '2', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('10', '新风考堂', null, null, null, '2', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('11', '通报曝光', null, null, null, '3', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('12', '巡视利剑', null, null, null, '3', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('13', 'AI小荷', null, null, null, '3', '0', '1536300390', null, '1');
INSERT INTO `c_permissions` VALUES ('14', '举报平台', null, null, null, '3', '0', '1536300390', null, '1');
...
CREATE TABLE `c_role` (
  ...
  `ctime` int(30) DEFAULT NULL COMMENT '创建时间',
  `menu_id` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='角色表';

-- ----------------------------
-- Records of c_role
-- ----------------------------
INSERT INTO `c_role` VALUES ('2', 'fasdf111', '1536577382', '2,7,8,9,10,3,11,12,13,14', 'fasdfdsa');
INSERT INTO `c_role` VALUES ('3', 'fasdf', '1536578931', '1,4,5,6', 'dddd');
...
CREATE TABLE `c_weixin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `openid` varchar(30) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT '微信的openid',
  `branch_id` int(10) DEFAULT NULL COMMENT '支部id',
  `public_name` varchar(10) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT '公众号名称',
  `role_id` int(11) NOT NULL COMMENT '公众号菜单栏',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci COMMENT='公众号表';

-- ----------------------------
-- Records of c_weixin
-- ----------------------------
INSERT INTO `c_weixin` VALUES ('1', null, null, '新风国机', '0');
INSERT INTO `c_weixin` VALUES ('2', null, null, '71cloud', '0');
INSERT INTO `c_weixin` VALUES ('3', '0', '0', 'fasdfdasf', '2');
INSERT INTO `c_weixin` VALUES ('4', 'fasdfdsadfas', '0', 'dfsadfasdf', '2');
