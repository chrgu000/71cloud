<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:107:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\content\ContentClassCourse\index.html";i:1541574067;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($CompanyClassData) || $CompanyClassData instanceof \think\Collection || $CompanyClassData instanceof \think\Paginator): $i = 0; $__LIST__ = $CompanyClassData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c va-m">
							...
							<td class="td-manage">
                                <a style="text-decoration:none" class="ml-5" onClick="edit('课程编辑','<?php echo Url('edit'); ?>','<?php echo $vo['id']; ?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
