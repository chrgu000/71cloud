<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\examactivity\add.html";i:1542188532;}*/ ?>
	...
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入活动名称" id="exam_activity_name" name="exam_activity_name">
			</div>
		</div>
		<div class="row cl">
...
$("#form-article-add").submit(function(){
    ...
    $.ajax({
        type:"post",
        url: "<?php echo Url('Examactivity/add'); ?>",
        data:formData,
        dataType:'json',
        processData:false,
        contentType:false,
