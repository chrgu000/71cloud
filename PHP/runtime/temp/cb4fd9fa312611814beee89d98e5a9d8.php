<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\permission\admin-role-edit.html";i:1540541247;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
	...
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['name']; ?>" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
				...
				<dl class="permission-list">
					<dd>
						<dl class="cl permission-list2">
							...
							<p>
								<label class="per">
									<?php if(in_array(($v['id']), is_array($data['menu_id'])?$data['menu_id']:explode(',',$data['menu_id']))): ?>
									<input type="checkbox" checked="checked" class="module" value="<?php echo $v['id']; ?>" name="menu_id[]" id="user-Character-0-0-0">
									<?php else: ?>
									...
									<label class="">
										<?php if(in_array(($v1['id']), is_array($data['menu_id'])?$data['menu_id']:explode(',',$data['menu_id']))): ?>
										<input type="checkbox"  checked="checked" class="action" value="<?php echo $v1['id']; ?>" name="menu_id[]" id="user-Character-1-0-0">
										<?php else: ?>
