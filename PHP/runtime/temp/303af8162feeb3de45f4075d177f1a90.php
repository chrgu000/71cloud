<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\dangyuan\memberadd.html";i:1540439357;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	 <form action="<?php echo url('membersave'); ?>"  class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data" method="post">
	<div class="row cl">
               <label class="form-label col-xs-4 col-sm-3">所属党支部：</label>
              <span><?php echo $branchsinfo['branchs_name']; ?></span>
		</div>
			<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-4"> <span class="select-box">
				<select id="cate_two" class="select" size="1" name="job_id">
					<option value="" selected>请选择行政职称名称</option>
					<?php if(($jobsname != "")): foreach($jobsname as $v): ?>
					<option value="<?php echo $v['id']; ?>" ><?php echo $v['job_name']; ?></option>
		...
		<div class="formControls col-xs-4 col-sm-4">
			<input type="text" class="input-text" value="" placeholder="" id="member_name" name="member_name">
		</div>
		</div>
	<div class="row cl">
