<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\branch_message\index.html";i:1539929730;}*/ ?>
<style type="text/css">
	/* 分页部分的css代码 */
...
<title>收件箱列表</title>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 党建消息管理 <span class="c-gray en">&gt;</span> 发件箱 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="40">ID</th>
				<th width="100">收件人名称</th>
				<th width="100">收件人所属党支部</th>
				<th width="100">消息主题</th>
				<th width="50">消息状态</th>
				<th width="90">发送日期</th>
				<th width="100">操作</th>
			</tr>
		...
		<tbody>
			<?php foreach($sendInfo as $v): ?>
				<tr class="text-c">
					...
					<td><?php echo $v['id']; ?></td>
					<td width="100"><?php echo $v['receive_name']; ?></td>
					<td width="100"><?php echo $v['branchs_name']; ?></td>
					<td><?php echo $v['title']; ?></td>
					<td width="50"><?php echo $v['status']; ?></td>
					<td width="150"><?php echo $v['create_time']; ?></td>
					<td class="td-manage" rel="">
                      	<span class="btn btn-primary radius" onclick="lookdetail(<?php echo $v['id']; ?>)" message_id = <?php echo $v['id']; ?>>查看</span> 
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
