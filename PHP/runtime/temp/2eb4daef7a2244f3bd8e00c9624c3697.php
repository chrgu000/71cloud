<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\branchadmin\index.html";i:1541574067;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="<?php echo url('create'); ?>" onclick="('添加管理员','admin-add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="40">ID</th>
				<th width="150">管理员名</th>
				<th width="40">子级管理员id</th>
				<th width="90">子级支部表id</th>
		...
		<?php foreach($list as $v): ?>
			<tr class="text-c">
				...
				<td class="td-manage" rel="<?php echo $v['status']; ?>">
					...
					<?php endif; ?>
				<a title="删除" href="<?php echo url('delete', ['id' => $v['id']]); ?>" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
...
function admin_stop(obj, id) {
    layer.confirm('确认要停用吗？', function (index) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo Url('branchadmin/statu'); ?>",
            data: {id: id, status: 0,},
            dataType: 'json',
...
function admin_start(obj, id) {
    layer.confirm('确认要启用吗？', function (index) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo Url('branchadmin/status'); ?>",
            data: {id: id, status: 1,},
            dataType: 'json',
            success: function (msg) {
                if (msg.error == 1) {
