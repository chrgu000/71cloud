<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\weixin\create.html";i:1539833840;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
     <form action="<?php echo url('save'); ?>" class="form form-horizontal" id="form-admin-add" method="post">
		...
		<div class="formControls col-xs-8 col-sm-9">
            ...
            <?php else: ?>
			    <input type="text" class="input-text" value="<?php echo $res['appid']; ?>" placeholder="" id="appid" name="appid">
            <?php endif; ?>
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
            ...
            <?php else: ?>
			    <input type="text" class="input-text" value="<?php echo $res['appsecret']; ?>" placeholder="" id="appsecret" name="appsecret">
            <?php endif; ?>
		</div>
	</div>
    
    <div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>配置微信认证 Token：</label>
		<div class="formControls col-xs-8 col-sm-9">
            <?php if(empty($res)): ?>
			    <input type="text" class="input-text" value="" placeholder="" id="token" name="token">
             <?php else: ?>
			    <input type="text" class="input-text" value="<?php echo $res['token']; ?>" placeholder="" id="token" name="token">
            <?php endif; ?>
		</div>
	</div>
