<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\ad\add.html";i:1540349568;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
	...
	<form class="form form-horizontal" method="post" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入名称" id="name" name="name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入外链地址" id="path" name="path">
			</div>
		</div>
...
$("#form-article-add").submit(function(){
    ...
    $.ajax({
        type:"post",
        url: "<?php echo Url('Ad/add',array('type'=>input('type'))); ?>",
        data:formData,
        dataType:'json',
        processData:false,
        contentType:false,
