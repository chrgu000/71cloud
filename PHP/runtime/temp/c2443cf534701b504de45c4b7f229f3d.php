<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\content\ContentAd\index.html";i:1541574067;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
			<a class="btn btn-primary radius" href="<?php echo Url('add',array('type'=>1)); ?>">
		...
		<div class="mt-20">
				...
				<tbody>
					<?php if(is_array($CompanyData) || $CompanyData instanceof \think\Collection || $CompanyData instanceof \think\Paginator): $i = 0; $__LIST__ = $CompanyData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c va-m">
                            ...
                            <!--onClick="edit('编辑','<?php echo Url('edit'); ?>','<?php echo $vo['id']; ?>','<?php echo \think\Request::instance()->get('type'); ?>')"-->
							<td class="td-manage"><a style="text-decoration:none" class="ml-5" href="<?php echo Url('edit',array('id'=>$vo['id'])); ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
            ...
            <input type="hidden" class="type_" value="<?php echo $type; ?>">
