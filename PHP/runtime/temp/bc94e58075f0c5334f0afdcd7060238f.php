<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\examactivity\create.html";i:1540439357;}*/ ?>
...
<article class="page-container">
    <form action="<?php echo url('save'); ?>"  class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data" method="post">
        <div class="row c1">
            <label class="form-label col-xs-3 col-sm-3">请输入活动名称：</label>
            <input type="text" name="exam_activity_name" value="">
        </div>
        <div class="row cl">
            <div class="col-xs-5 col-sm-5 col-xs-offset-6 col-sm-offset-3">
                <input name="" type="submit" class="btn btn-success radius size-S" value="&nbsp;提&nbsp;&nbsp;&nbsp;&nbsp;交&nbsp;">
            </div>
        </div>
    </form>
</article>
