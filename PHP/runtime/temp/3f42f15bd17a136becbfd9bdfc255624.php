	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php foreach($list as $v): ?>
			...
			<tr class="text-c">
				...
				<td><?php echo $v['id']; ?></td>
				<td><?php echo $v['app_classname']; ?></td>
				<td><?php echo $v['name']; ?></td>
				<td><?php echo $v['appid']; ?></td>
				<td><img src="<?php echo $v['image']; ?>"></td>
				<td><?php echo $v['count']; ?></td>
				<td><?php echo $v['sort']; ?></td>
				<td class="f-14"><a title="编辑" href="<?php echo url('create',['id'=>$v['id']]); ?>" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="<?php echo url('delete',['id'=>$v['id']]); ?>" onclick="admin_role_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
