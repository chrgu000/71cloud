<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\classCate\add.html";i:1540438291;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
...
$(function(){
	...
	/*$("#form-cate-add").validate({
		...
		submitHandler:function(form){
			...
			$(form).ajaxSubmit({
				type: 'post',
				url: "<?php echo Url('ClassCate/add'); ?>" ,
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data.code == 1){
                layer.msg(data.msg,{icon:1,time:1000});
                setTimeout(function () {
                    window.location.href=("<?php echo Url('ClassCate/index'); ?>");
                } ,1000);
            }
        }
