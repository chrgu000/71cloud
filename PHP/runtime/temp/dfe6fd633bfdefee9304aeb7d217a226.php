<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\applets\create.html";i:1542857192;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1541574066;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1541387770;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>七一云党建</title>
...
<article class="page-container">
	 <?php if((empty($arr))): ?>
		...
		<div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="appname" name="appname">
            </div>
	    </div>
         <div class="row cl ">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序分类：</label>
             &nbsp;&nbsp;&nbsp;
             <!--<div class="formControls col-xs-8 col-sm-9">-->
                   <?php foreach($list as $v): ?>
                       <input type="radio" id="<?php echo $v['id']; ?>" value="<?php echo $v['id']; ?>" name="app_class_id"><?php echo $v['app_classname']; endforeach; ?>
             <!--</div>-->
	</div>
	<div class="row cl">
    ...
    <?php else: ?>
            <form action="" class="form form-horizontal" id="form-admin-add" method="post">
                ...
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo $arr['name']; ?>" placeholder="" id="appname" name="appname">
                </div>
            </div>
                 <div class="row cl ">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序分类：</label>
                     ...
                     <!--<div class="formControls col-xs-8 col-sm-9">-->
                           <?php foreach($list as $v): if(($v['id'] == $arr['id'])): ?>
                                    <input type="radio" checked="checked" id="<?php echo $v['id']; ?>" value="<?php echo $v['id']; ?>" name="app_class_id"><?php echo $v['app_classname']; endif; ?>
                                    <input type="radio" id="<?php echo $v['id']; ?>" value="<?php echo $v['id']; ?>" name="app_class_id"><?php echo $v['app_classname']; endforeach; ?>
                     <!--</div>-->
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input type="hidden" name="applets_id" value="<?php echo $arr['applets_id']; ?>">
                     <input name="" type="submit" class="btn btn-success radius size-L" value="&nbsp;提&nbsp;&nbsp;&nbsp;&nbsp;交&nbsp;">
                </div>
            </div>
        </form>
