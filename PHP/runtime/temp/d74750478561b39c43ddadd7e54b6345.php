<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\applets\class_create.html";i:1542614593;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1541574066;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1541387770;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>七一云党建</title>
...
<div class="cl pd-5 bg-1 bk-gray">
		<span class="l">
			...
			<a class="btn btn-primary radius" href="<?php echo Url('create'); ?>">
				<i class="Hui-iconfont">&#xe600;</i> 添加小程序
			</a>
...
<article class="page-container">
	 <form action="<?php echo Url('save_class'); ?>"  class="form form-horizontal" id="form-admin-add" method="post">

		<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>小程序分类名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
            <?php if(!empty($app_classname)): ?>
                <input type="text" class="input-text" value="<?php echo $app_classname['app_classname']; ?>" placeholder="" id="appname" name="app_classname">
                <input type="hidden" name="app_class_id" id = "app_class_id" value="<?php echo $app_classname['id']; ?>">
            <?php else: ?>
                <input type="text" class="input-text" value="" placeholder="" id="appname" name="app_classname">
                <input type="hidden" name="app_class_id" id = "app_class_id" value="">
            <?php endif; ?>
		</div>
	</div>
<!--	<div class="row cl">
	 ...
	 <div class="row cl">
		 ...
		 <div class="formControls col-xs-8 col-sm-9">
			 ...
			 &lt;!&ndash;<input type="file" class="input-text" placeholder="" name="thumb" id="thumb">&ndash;&gt;
	...
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
			 <input name="" type="button" class="btn btn-success radius size-L submit" value="&nbsp;提&nbsp;&nbsp;&nbsp;&nbsp;交&nbsp;">
		</div>
	</div>
	</form>
</article>
...
// });
    ...
    $(".submit").click(function () {
        ...
        var app_class_id = $("#app_class_id").val()
        $.ajax({
            type:"post",
            url: "<?php echo Url('save_class'); ?>",
            data:{appname:appname,app_class_id:app_class_id},
            success:function(data){
                // console.log(data)
                ...
                if(data.code == 1){
                    layer.msg(data.msg,{icon:1,time:1000});
                    setTimeout(function () {
                        window.location.href=('<?php echo Url("classification"); ?>');
                    } ,1000);
                }
            }
