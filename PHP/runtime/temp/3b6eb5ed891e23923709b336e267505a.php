<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\permission\admin-permission-add.html";i:1541054526;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="roleName" name="per_name">
            </div>
        </div>
        <div class="row cl">
        ...
        <!--<div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="pagemodule" name="pagemodule">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="operate" name="operate">
            </div>
        </div>-->
        <div class="row cl">
...
<script type="text/javascript">
   ...
   /* //点击全选事件
    $(".input_all").click(function(){
        ...
        if(status){
            $(".pagemodule,.action").prop("checked","checked");
            //$(".action").attr("checked","checked");
        }else{
            $(".pagemodule,.action").prop("checked","");
            //$(".action").attr("checked","");
        }
    })*/
