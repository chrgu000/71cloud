<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\weixin\menu.html";i:1540866004;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <?php if(empty($list)): ?>
     ...
     <?php else: ?>
        <input type="text" class="input-text" value="<?php echo $list['menu_name']; ?>" placeholder="" id="appid" name="menu_name">
            ...
            <input type="hidden" class="menu_input" name="branch_admin_id" value="<?php echo $list['branch_admin_id']; ?>">
    <?php endif; ?>
