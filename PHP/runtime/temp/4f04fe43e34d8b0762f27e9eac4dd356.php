<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\weixin\menuindex.html";i:1541574067;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="<?php echo url('menu'); ?>" onclick="('添加管理员','admin-add.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加菜单栏</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
            ...
            <?php foreach($list as $v): ?>
                <tr class="text-c">
                    ...
                    <?php if($v['p_lv_id'] == 0): ?>
                        <td>一级菜单</td>
                    <?php else: ?>
                        <td><?php echo $v['p_lv_id']; ?></td>
                    <?php endif; ?>
                    <td><?php echo $v['menu_name']; ?></td>
                    <td><?php echo $v['menu_description']; ?></td>
                    <td><?php echo $v['menu_url']; ?></td>
                    <td><?php echo $v['branch_admin_id']; ?></td>
                    <td><?php echo date("Y-m-d,H:i:s",$v['ctime']); ?></td>
                    <td class="td-manage">
                        <a title="编辑" href="<?php echo url('edit_menu', ['id' => $v['id']]); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                        <a title="删除" href="<?php echo url('delete_menu', ['id' => $v['id']]); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
		</tbody>
