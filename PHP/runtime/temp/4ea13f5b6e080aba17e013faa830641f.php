<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\classChapter\edit.html";i:1540519608;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
	...
	<form class="form form-horizontal"  id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['name']; ?>" placeholder="请输入视频名称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['episode']; ?>" placeholder="本视频属于课程第几章节，请输入数字" id="episode" name="episode">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['path']; ?>" placeholder="请输入视频地址" id="path" name="path">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['vtime']; ?>" placeholder="请输入视频时长，单位为秒" id="vtime" name="vtime">
			</div>
		</div>
