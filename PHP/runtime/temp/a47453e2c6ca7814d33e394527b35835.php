<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\content\ContentClassCate\index.html";i:1541574067;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		...
		<a href="javascript:;" onclick="cate_add('添加分类','<?php echo Url('add'); ?>')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> </div>
		...
		<tbody>
			<?php if(is_array($CompanyData) || $CompanyData instanceof \think\Collection || $CompanyData instanceof \think\Paginator): $i = 0; $__LIST__ = $CompanyData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td class="td-manage">
						<a title="编辑" href="javascript:;" onclick="cate_edit('分类编辑','<?php echo Url('edit'); ?>','<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
