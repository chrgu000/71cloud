<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/admin\view\pagemodule\edit.html";i:1541060811;s:65:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\layout.html";i:1539913150;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\header.html";i:1540622524;s:72:"D:\PHPTutorial\WWW\71cloud\PHP\application\admin\view\public\footer.html";i:1540368457;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <title>71云党建</title>
...
<article class="page-container">
	 <form action=""  class="form form-horizontal" id="form-admin-add" method="post" enctype="multipart/form-data">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $res['module_name']; ?>" placeholder="" id="module_name" name="module_name">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>控制器：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $res['auth_c']; ?>" placeholder="" id="auth_c" name="auth_c">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>操作方法：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $res['auth_a']; ?>" placeholder="" id="auth_a" name="auth_a">
		</div>
	</div>
	 <div class="row cl">
		 ...
		 <div class="formControls col-xs-8 col-sm-9">
			 ...
			 <div style="border: 1px solid #ddd;width: 200px;height: 150px;margin: 10px 0px;">
				 <div  style="width: 190px;height: 140px;margin:5px 0 0 5px;background:url('/static/admin/static/h-ui.admin/images/noimage.jpg') no-repeat ;background-size:190px 140px;">
					 <img src="<?php echo $res['thumb']; ?>" id="imgId"  video-time="" style="width: 190px;height: 140px;" alt="" />
				 </div>
...
<script type="text/javascript">
	...
	$("#form-admin-add").submit(function(){
		...
		$.ajax({
			type:"post",
			url: "<?php echo Url('Pagemodule/edit',array('id'=>input('id'))); ?>",
			data:formData,
			dataType:'json',
			processData:false,
			contentType:false,
