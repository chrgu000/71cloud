...
<div class="page-container">
	...
	<!--<div class="text-c">
		<form action="<?php echo Url('adminindex'); ?>" method="get">
			&lt;!&ndash;<input type="text" onfocus="WdatePicker({ maxDate:'#F{ $dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" class="input-text Wdate" style="width:120px;">
			-
			...
			<input type="text" class="input-text" style="width:250px" placeholder="输入管理员名称" value="<?php echo \think\Request::instance()->get('title'); ?>" id="" name="title">
