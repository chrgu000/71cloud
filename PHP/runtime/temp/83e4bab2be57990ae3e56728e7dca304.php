<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\PHPTutorial\WWW\71cloud\PHP\public/../application/branchadmin\view\hearts\index.html";i:1541982889;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
			<a class="btn btn-primary radius" href="<?php echo Url('ContentNews/add'); ?>"><i class="Hui-iconfont">&#xe600;</i> </a></span> <span class="r">共有数据：<strong></strong> 条</span> </div>
		<div class="mt-20">
				...
				<tbody>
                    <tr class="text-c va-m">
                        <?php foreach($list as $k=>$v): ?>
                            <td><input type="checkbox" id="<?php echo $v['id']; ?>" class="company" value="" name="content"></td>
                            <td><?php echo $v['content']; ?></td>
                            <td><img width="100" height="60" name='take' class="product-thumb" src="<?php echo $v['take']; ?>"></td>
                            <td class="text-l"><?php echo $v['rudang_shijian']; ?></td>
                            <td><?php echo $v['audit_opinion']; ?></td>
                            <td class="td-manage">
