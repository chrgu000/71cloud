...
@interface RedHeartListViewController ()<XYYSegmentControlDelegate>
...
@implementation RedHeartListViewController
...
{
    RedHeartListRootViewController *root = [[RedHeartListRootViewController alloc] init];
...
{
    RedHeartListRootViewController *root = view.viewArray[number];
