...
+ (LZBKeyBoardToolBar *)showKeyBoardWithConfigToolBarHeight:(CGFloat)toolBarHeight sendTextCompletion:(void(^)(NSString *sendText))sendTextBlock
{
    ...
    toolBar.backgroundColor = LZBColorRGB(255 ,255, 255);
...
- (void)layoutSubviews
{
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        weakSelf.sendBtn.LZB_y = weakSelf.LZB_heigth - sendButtonSize.height -kKeyboardViewToolBar_Vertical_DefaultMargin-6;
...
- (UIButton *)sendBtn
{
  if(_sendBtn == nil)
  {
      ...
      [_sendBtn setImage:[UIImage imageNamed:@"pro_icon_dispatch"] forState:UIControlStateNormal];
